...
public class JanelaAluno {
	...
	public void criarTela() {
		...
		box.setBounds(120,275 , 120, 30);
		 ...
		 labelImc.setBounds(400, 80, 80, 30);
		...
		buttonCalcular.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				a.setNome(textNome.getName());
				
				textNome.setText(a.getNome());
				
				a.setCalcularImc(Double.parseDouble(textImc.getText()));
				a.setCalcularNcd(Double.parseDouble(textNCD.getText()));
								
				labelImc.setText("IMC:"  + String.valueOf(a.getCalcularImc()));
				labelNCD.setText("NCD: " + String.valueOf(a.getCalcularNcd()));
			}
		});
